...
using MemberShip.Models.Mapping;
...
namespace MemberShip.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public DbSet<Getir> Getirs { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new GetirMap());
            ...
            modelBuilder.Configurations.Add(new UrunRaporlaMap());
